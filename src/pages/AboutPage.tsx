        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 lg:py-24">
          ...
          <section className="mb-24">
            <Badge className="bg-white text-rysys-black border-4 border-rysys-black rounded-none px-6 py-2 font-mono uppercase font-black text-sm shadow-brutal-gold mb-8">
              Public Interest // Civic Stewardship
            </Badge>
            ...
            <p className="text-xl md:text-3xl font-sans font-black leading-tight max-w-3xl text-muted-foreground border-l-8 border-rysys-gold pl-8 md:pl-12 py-4">
              We partner with communities and agencies to engineer equitable, durable infrastructure for all residents.
            </p>
          </section>
          {/* Leadership Bio */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-8 space-y-8">
                <div className="space-y-4">
                  <h3 className="text-4xl font-display font-black uppercase tracking-tight">Community Leadership</h3>
                  <div className="flex flex-wrap gap-4 items-center">
                    <span className="text-sm font-black text-rysys-gold uppercase tracking-widest font-mono border-2 border-rysys-gold px-3 py-1">Portland Infrastructure</span>
                    <span className="text-sm font-black text-rysys-blue-power uppercase tracking-widest font-mono border-2 border-rysys-blue-power px-3 py-1">Public Interest Engineering</span>
                  </div>
                </div>
                <p className="text-xl leading-relaxed font-bold">
                  RYSYS was founded to rethink industrial infrastructure through the lens of transparency, collaboration, and public benefit.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    "Civic Engineering Stewardship",
          ...
          <section className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <CapabilitySummaryCard
                ...
                title="01. Vision for Access"
                description="Computer vision tools for neighborhood wayfinding and public accessibility."
                tags={["Public Tools", "Open", "Inclusive"]}
              />
              <CapabilitySummaryCard
                icon={<Globe className="w-8 h-8" />}
                title="02. Neighborhood Resilience"
                description="Energy modeling and microgrids focused on community energy security."
                tags={["Resilience", "Green", "Civic"]}
              />
              <CapabilitySummaryCard
                icon={<Code2 className="w-8 h-8" />}
                title="03. Public Assets"
                description="Infrastructure integration for public works, libraries, and utilities."
                tags={["Systems", "Public", "Transparent"]}
              />
            </div>
          </section>
          <section id="business-plan" className="mb-24">
            <div className="mb-12">
              <h2 className="text-4xl md:text-6xl font-display font-black uppercase tracking-tight mb-4">
                Civic <span className="text-rysys-gold">Plan</span>
              </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <Accordion type="single" collapsible defaultValue="mission-1" className="w-full space-y-4">
                  <AccordionItem value="mission-1" className="border-4 border-rysys-black px-4 bg-rysys-cream/20">
                    <AccordionTrigger className="hover:no-underline font-black uppercase text-sm tracking-widest text-left py-4">
                      Serve Portland with Transparency
                    </AccordionTrigger>
                    <AccordionContent className="pb-4 pt-2">
                      <ul className="space-y-4">
                        <li className="flex gap-3">
                          <CheckCircle2 className="w-5 h-5 text-rysys-gold shrink-0 mt-0.5" />
                          <span className="text-sm font-bold">Transparent engineering and open documentation as our standard.</span>
                        </li>
                        <li className="flex gap-3">
                          <CheckCircle2 className="w-5 h-5 text-rysys-gold shrink-0 mt-0.5" />
                          <span className="text-sm font-bold">Collaborative infrastructure improvements for neighborhoods.</span>
                        </li>
                      </ul>
                    </AccordionContent>
                  </AccordionItem>
              ...
              <Card className="bg-white border-4 border-rysys-black rounded-none p-8 shadow-brutal-blue hover:shadow-brutal-blue-lg transition-all group flex flex-col h-full">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h3 className="text-2xl font-black uppercase tracking-tighter">Team & Stewardship</h3>
                </div>
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3">
                      <Badge className="bg-rysys-gold text-white border-none rounded-none px-3 font-black">Operator</Badge>
                      <span className="text-xs font-black uppercase tracking-widest text-rysys-blue-power">Community Systems Engineer</span>
                    </div>
                  </div>
